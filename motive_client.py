...
def receive_mocap_data_frame(mocap_data):
    ...
    # if rigid_body_data.get_rigid_body_count() == 1 and labeled_marker_data.get_labeled_marker_count() == 5:
    #     rigid_body_list = rigid_body_data.rigid_body_list
    #     labeled_marker_list = labeled_marker_data.labeled_marker_list

    #     for rigid_body in rigid_body_list:
    #         print(f"Rigid body ID: {rigid_body.id_num}")
    #         print(len(rigid_body.rb_marker_list))
    #         # for marker in rigid_body.rb_marker_list:
    #         #     print(marker.id_num)

    #     print()

    #     for labeled_marker in labeled_marker_list:
    #         print(labeled_marker.id_num)
